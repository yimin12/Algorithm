...
* @version Create Time：2020年3月29日 下午3:58:52
* Description:
* 	Serialize and deserialize a trie (prefix tree, search on internet for more details).
* 	You can specify your own serialization algorithm, the online judge only cares about whether you can 
* 	successfully deserialize the output from your own serialize function.
...
public class TrieSerialization {
	...
	public TrieNode deserialize(String data) {
		...
		Deque<TrieNode> path = new LinkedList<TrieNode>();
