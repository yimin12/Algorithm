...
public class LowestCommonAncestor {
	...
	public TreeNode LCAIIterative(TreeNode root, TreeNode one, TreeNode two) {
		// param1: key : traversed node, param2: value: return node the ancestor if detected
		Map<TreeNode, TreeNode> parent = new HashMap<TreeNode, TreeNode>();
		Deque<TreeNode> stack = new ArrayDeque<TreeNode>();
		parent.put(root, null);
		stack.push(root);// simulate recursion
		while(!parent.containsKey(one) || !parent.containsKey(two)) {
